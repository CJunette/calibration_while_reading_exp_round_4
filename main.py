...
if __name__ == '__main__':
    ...
    # temporary_functions.combine_temp_csv("8_21_fine_duration_third_from_gpt") # 将text/round_1/weight/temp文件夹中的csv文件合并成一个文件。
    ...
    # analyse_reading_data.add_all_reading("8_21_fine_duration_third_from_gpt_90-94.csv")
